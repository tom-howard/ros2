...
Once the final Exam Timetable has been released (early May, [more details here](https://students.sheffield.ac.uk/exams/timetables){target="_blank"}), teams will be invited to select a preference for when they'd like their Viva to take place. You'll be able to pick either a morning (between 9 AM and 12 Noon) or afternoon (between 1 and 4 PM) slot on a specific date. There will be 6 slots available per morning/afternoon (i.e. 30 minute slots) and preferences are first come, first served: once all slots are taken, that's it!
...
| Session Time<br />(approx.) | Details |
| :--- | :--- |
| 0-5 mins | Task 3 assessment |
| 5-20 mins | Q&A Session |
| 20-25 min | Wrap-up & depart |

</center>

**Please arrive on time to your Viva**, we won't be able to wait for latecomers!
...
If a team member doesn't show up to their team's Viva, they'll get 0/20 marks for this component of Assignment #2 Part B. We won't be able to reschedule Vivas for individuals or teams who miss their slot, so **please be there**!

## The Q&A Session {#assessment}

This is the main part of the Viva, and it's worth 20 of the 60 marks for [Assignment #2 Part B](README.md).
...
You're allowed to use Generative AI to support your team's work on Task 3. **But**, if you do use it make sure it's to *inform* your work, not *create* it for you.
...
### Scrutiny of AI Usage

[As discussed above](#assessment), during the Vivas we'll ask you to explain specific details about the code you've submitted for Task 3, its purpose and function, and why you chose to implement it this way. If we suspect code has been generated by AI and you can't explain any aspect of it to us satisfactorily, the submission will be investigated for academic misconduct. In serious cases, the team could receive 0/60 marks for Assignment #2 Part B overall.
